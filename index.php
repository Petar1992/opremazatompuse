...
<?php
	...
	$default_page = isset($_GET['page'])?$_GET['page']:"pocetna";

        $pages = array (
        			"pocetna" => "pages/pocetna.php",
                    "specijalna-ponuda" => "pages/specijalna_ponuda.php",
                   /* "dostava" => "pages/dostava.php",*/
                    "kontakt" => "pages/kontakt.php",
                    "proizvodi" => "pages/proizvodi.php",
                    "detalji" => "pages/proizvod_detalji.php",
                    "korpa" => "pages/korpa.php",
                    "porudzbina" => "pages/poruci.php",
                    "sviproizvodi" => "pages/sviproizvodi.php"
                );
